    ...
    <X.MainContainer>
      ...
      <div>
        {soloRankData?.mostLanes.map((data) => (
          <>
            {data.lane === "Top" && (
              <X.LaneBox onClick={() => onHandle("Top")}>
                <div>
                  <X.LineImage>
            ...
            {data.lane === "Jug" && (
              <X.LaneBox onClick={() => onHandle("Jug")}>
                <div>
                  <X.LineImage>
            ...
            {data.lane === "Mid" && (
              <X.LaneBox onClick={() => onHandle("Mid")}>
                <div>
                  <X.LineImage>
            ...
            {data.lane === "Adc" && (
              <X.LaneBox onClick={() => onHandle("Adc")}>
                <div>
                  <X.LineImage>
            ...
            {data.lane === "Sup" && (
              <X.LaneBox onClick={() => onHandle("Sup")}>
                <div>
                  <X.LineImage>
